...
M.block_ajax_marking.courses_tree = function () {
    M.block_ajax_marking.markingtree.superclass.constructor.call(this, 'coursestree');
};

// Make the courses tree into a subclass of the base class
YAHOO.lang.extend(M.block_ajax_marking.courses_tree, M.block_ajax_marking.markingtree, {
...
M.block_ajax_marking.cohorts_tree = function () {
    ...
    M.block_ajax_marking.markingtree.superclass.constructor.call(this, 'cohortstree');
};

// make the groups tree into a subclass of the base class
YAHOO.lang.extend(M.block_ajax_marking.cohorts_tree, M.block_ajax_marking.markingtree, {
...
M.block_ajax_marking.users_tree = function () {
    M.block_ajax_marking.markingtree.superclass.constructor.call(this, 'usersstree');
};

// make the users tree into a subclass of the base class
YAHOO.lang.extend(M.block_ajax_marking.users_tree, M.block_ajax_marking.markingtree,
...
M.block_ajax_marking.config_tree = function () {
    ...
    M.block_ajax_marking.markingtree.superclass.constructor.call(this, 'configtree');
};

// make the config tree into a subclass of the base class. Tell it to use custom nodes
YAHOO.lang.extend(M.block_ajax_marking.config_tree, M.block_ajax_marking.markingtree, {
