...
/**
 * Wrapper for the main functions library class which adds the parts that deal with the HTML list generation.
 *
 ...
 * class and this is extended by either the ajax_marking_response class in the ajax.php file, or the HTML_list
 * class here.
 *
 * @copyright 2008 Matt Gibson
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
