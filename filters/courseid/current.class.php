 ...
 */
class block_ajax_marking_filter_courseid_current extends block_ajax_marking_filter_base {
     ...
     */
    public static function nextnodetype_filter(block_ajax_marking_query_base $query) {
