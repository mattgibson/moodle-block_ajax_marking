 ...
 *
 */
M.block_ajax_marking.markingtree = function (treediv) {
    M.block_ajax_marking.markingtree.superclass.constructor.call(this, treediv);

    this.singleNodeHighlight = true;
};

// Make the base class into a subclass of the YUI treeview widget.
YAHOO.lang.extend(M.block_ajax_marking.markingtree, YAHOO.widget.TreeView, {
    ...
    add_loading_icon : function () {
        this.tab.refreshbutton.set('label',
                                   '<img src="'+M.cfg.wwwroot+'/blocks/ajax_marking/pix/ajax-loader.gif"'+
                                       ' class="refreshicon"'+
    ...
    remove_loading_icon : function () {
        this.tab.refreshbutton.set('label',
                                   '<img src="'+M.cfg.wwwroot+'/blocks/ajax_marking/pix/refresh-arrow.png"'+
                                       ' class="refreshicon"'+
                                       ' alt="'+M.str.block_ajax_marking.refresh+'" />');
