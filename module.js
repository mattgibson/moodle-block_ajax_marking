...
M.block_ajax_marking.main = {
    ...
    /**
     * Stored reference to the Yahoo global object.
     */
    Y : null,
    ...
    contextmenu_add_groups_to_menu : function (menu, clickednode) {
        ...
        for (i = 0; i < numberofgroups; i += 1) {
            ...
            newgroup = {
                ...
                "onclick" : {
                    fn : M.block_ajax_marking.contextmenu_setting_onclick,
    ...
    show_error : function (errormessage, notloggedin) {
        ...
        if (M.cfg.developerdebug === undefined && !notloggedin) {
        ...
        this.Y.one('block_ajax_marking_error').setStyle('display', 'block');
        if (notloggedin) {
            // Login message never needs scroll bars and they mess it up
            this.Y.one('block_ajax_marking_error').setStyle('overflow-x', 'auto');
        }
    },
    ...
    get_dynamic_icon : function (iconname, alttext) {
        ...
        var icon = this.Y.one('block_ajax_marking_' + iconname + '_icon'),
            newicon;
    ...
    make_icon_styles : function () {
        ...
        imagediv = this.Y.one('dynamicicons');
    ...
    initialise : function (Y) {
        ...
        M.block_ajax_marking.tabview.after('selectionChange', function () {
            ...
            if (currenttab.alreadyinitialised === undefined) {
                currenttab.displaywidget.initialise();
